...
def ask_copilot(
    ...
    system_prompt = (
        ...
        "Long-only Strategie (Swing):\n"
        "- Regime-Filter: nur Long, wenn Kurs > MA200, EMA20 > EMA50 oder mindestens EMA50 > MA200; ADX >= 18; RVOL >= 0.8; ATR% nicht extrem (>10%).\n"
        "- Setups:\n"
        "  * Trend-Dip: Trend intakt (EMA20>EMA50>MA200), Pullback zur Value-Zone (BB-Mid oder EMA50), RSI 35–55 steigend.\n"
        "  * Breakout-Fortsetzung: Trend intakt, Close über BB-Mid/EMA20, RSI 50–65 steigend, Volumen ok/expanding.\n"
        "  * Reclaim: Flush unter EMA50, dann Close wieder über EMA50 mit steigendem RSI.\n"
        "- Exits/De-Risk:\n"
        "  * Überhitzung: Close > bb_up und RSI > 72 fallend → SELL; extreme Überhitzung (RSI > 80 & weit über EMA20) → STRONG SELL.\n"
