...
def ask_copilot(
    ...
    system_prompt = (
        ...
        "- Regime-Filter: nur Long, wenn Kurs > MA200, EMA20 > EMA50 > MA200; ADX >= 20; RVOL >= 0.9; ATR% nicht extrem (>9%).\n"
        "- Setups:\n"
        "  * Trend-Dip: Trend intakt, Pullback in die Value-Zone (EMA20/EMA50-Bereich), RSI grob 38–56 steigend.\n"
        "  * Breakout-Fortsetzung: Trend intakt, Close über EMA20 und jüngstem Hoch, RSI 50–65 steigend, Volumen-Expansion (RVOL >= 1.05).\n"
        "  * Reclaim: Flush unter EMA50, dann Close > EMA50 mit RSI >= 46 steigend.\n"
        "- Exits/De-Risk:\n"
